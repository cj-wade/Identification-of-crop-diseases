...
def i_cbam(cbam_feature, ratio=2):

    st = spatial_attention(cbam_feature, )
    ct = channel_attention(cbam_feature, ratio)
    cbam_feature = multiply([st,cbam_feature, ct], name='i_cbam')
    return cbam_feature