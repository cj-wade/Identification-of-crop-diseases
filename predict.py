...
def valid(labelspath,resultpath):
    ...
    for i in range(total):
        ...
        if labels[i] in top_5_pred:  # top_5准确率
            top_5_acc += 1
    ...
    print("Top_1准确率：", top_1_acc / total)
    print("Top_5准确率：", top_5_acc / total)
    print("品种准确率：", crop_type_acc / total)
    print("病虫害种类准确率：", disease_type_acc / total)
